...
class FusedModel(object):
    def __init__(self, embeddings):
        weights = {
            ...
            'wc2': tf.Variable(tf.truncated_normal([filter_sizes[1], filter_num, filter_num], stddev=0.1)),
            'wc3': tf.Variable(tf.truncated_normal([filter_sizes[2], filter_num, filter_num], stddev=0.1))
        }
    ...
    def multi_conv(self, x, weights, biases):
        ...
        conv3 = self.conv1d(conv2, weights['wc3'], biases['bc3'], pooled=True)
